...
\begin{figure}[htb]
    \centering
    \includegraphics[width=5cm]{./images/blank_img.jpg}
    \caption{Kontaktgeometrie bei nichtkonforme Paarungen}
    \label{fig:kontaktgeometrie_nichtkonforme_kontakte}
\end{figure}
%

Da die Versuche dieser Arbeit auf einem Kugel-Scheibe-Modellprüfstand durchgeführt werden, wird der Körper 1 als eine Kugel und der Körper 2 als eine Scheibe betrachtet.
Im Kontaktpunkt bildet sich die Kontaktflächen eine Ellipse mit den Halbachsen $a$ und $b$ (Abbildung~\ref{fig:kontaktgeometrie_kugel_scheibe_model}).
% ----------------------------------------
% Fig: Kontaktgeometrie Kugel-Scheibe
% ----------------------------------------
\begin{figure}[htb]
    \centering
    \includegraphics[width=5cm]{./images/blank_img.jpg}
    \caption{Kontaktgeometrie beim Kugel-Scheibe-Model}
    \label{fig:kontaktgeometrie_kugel_scheibe_model}
\end{figure}
%
...
% ----------------------------------------
% Eq: Der reduzierte Elastizitätmodul E
% ----------------------------------------
\begin{equation}
...
\end{equation}
%
Die Koeffizienten $\beta_a$ und $\beta_b$ wird über den Parameter $\cos{\psi}$ bestimmt
% ----------------------------------------
% Eq: cos psi
% ----------------------------------------
\begin{equation}
...
Bei einem Kugel-Scheibe-Modell gilt
%
\begin{align*}
