...
Nach Dowson und Higginson kann die Berechnung der Schmierfilmdicke durch vier dimensionslose Größe verallgemeinert werden.
% ----------------------------------------
...
In einer Reihe von Veröffentlichungen in 1976-1977 wurde von Dowson und Hamrock Formel zur Berechnung der minimalen und zentralen Schmierfilmdicke in elliptischen Punktkontakten angeführt.
% ----------------------------------------
% Eq: Schmierfilmdicke von Dowson und Hamrock
% ----------------------------------------
\begin{align}
    \label{eq:schmierfilmdicke_downson_hamrock}
    H_{min} &= \cfrac{3,63 G^{0,49} U_0^{0,68}}{W_0^{0,073}} (1 - e^{-0,68 \chi}) \\
    H_0 &= \cfrac{2,69 G^{0,53} U_0^{0,67}}{W_0^{0,067}} (1 - 0,61 e^{-0,73 \chi})
\end{align}
%
wobei $\chi = a/b$ das Verhältnis der Halbachsen der Kontaktellipse ist.
Nach den experimentellen Ergebnissen von Kyoe\improvement{Quelle} kann man die Formel \ref{eq:schmierfilmdicke_downson_hamrock} im Bereich $0,117 < \chi < 3,7$ verwenden.
