function [index,  C, R_p, stuetz_unten, stuetz_oben] = kurve_bewerten_func (kurve, zeitbasis, messung, inkrement, U_lade, R_lade, messinfo)
...
if (index==1)
    while (bewerten)
        ...
        ladekurve_calc( C, R_p, kurve, zeitbasis, R_lade, U_lade, i_unten, i_oben, inkrement, messung, messinfo);
