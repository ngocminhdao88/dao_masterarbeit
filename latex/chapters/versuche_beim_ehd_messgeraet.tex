...
Das Messgerät besteht aus zwei Stahlbacken, die auf einem Gestell aufgehängt werden, einem Zylinder und der elektronischen Einheit.
% ----------------------------------------
% Fig: Kapazitiv Wegmessgerät beim IMKT
% ----------------------------------------
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.8\linewidth]{./images/wegmessgeraet_imkt.jpg}
...
\begin{figure}[htb]
    ...
    \caption{Schematischer Aufbau des Prüfkopfs des Wegmessgeräts}
    \label{fig:schematischer_aufbau_des_pruefkopfs_des_wegmessgeraets}
\end{figure}

Die Messung der Höhe des Spalts zwischen den Backen erfolgt durch die Betrachtung ihn als ein Plattenkondensator, welcher die Luft als Dielektrikum hat.
Bei dem Einfordern des Öls in den Spalt ändert sich das Dielektrikum von Luft zu Luft + Öl, damit verändert sich auch seine Kapazität bzw. seinen Höhe, obwohl sie konstant bleibt.
Durch das Phänomen wird die Dielektrizitätskonstante des Öls als das Verhältnis zwischen den Messwerten bei Luft und bei Öl berechnet.
Die Messergebnisse von dem Öl \textit{FVA 3} bei verschiedenen Temperatur \SIrange{20}{80}{\degreeCelsius} in der Tabelle dargestellt.

\improvement[inline]{Tabelle der Dielektrizitätskonstante}
