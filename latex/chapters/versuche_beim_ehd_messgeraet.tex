...
Die Werte $R_1 = 2$ \si{\kilo\ohm} und $C_1 = 22$ \si{\pico\farad} wurden durch Experiment für weitere Messungen in dieser Arbeit gewählt.
...
\improvement[inline]{Update the figure}
