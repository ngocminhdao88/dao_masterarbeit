...
In Abbildung~\ref{fig:filmdicke_kapazitaet_geschwindigkeit} wird die Schmierfilmdicke und die Kapazität des Öls \textit{SHC320} in Abhängigkeit mit der Geschwindigkeit.
...
Bei niedriger Geschwindigkeit bekommt man besser Auflösung, aber gibt es auch die Gefahr, durch die Berührung von Rauheitsspitzen das Messergebnis verfälscht wird.
% ----------------------------------------
...
\begin{figure}[htb]
    ...
    \caption{Der Zusammenhang zwischen Schmierfilmdicke und Kapazität mit der Geschwindigkeit von dem \textit{SHC320} bei \SI{40}{\degreeCelsius} und \SI{20}{\N}}
    \label{fig:filmdicke_kapazitaet_geschwindigkeit}
\end{figure}

Die Temperatur hat relativ große Wirkung auf die Filmdicke und die Kapazität (siehe Abbildung~\ref{fig:filmdicke_kapazitaet_temperatur}).
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=4cm]{./images/blank_img.jpg}
    \caption{Auswirkung der Temperatur auf die Filmdicke und die Kapazität}
    \label{fig:filmdicke_kapazitaet_temperatur}
\end{figure}
