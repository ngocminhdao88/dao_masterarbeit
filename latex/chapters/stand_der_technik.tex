...
\begin{tabular}{lll}
    $0,001 \rightarrow 0,1$ & für & $\eta_0$ [\si{Pa.s}] \\
    $0 \rightarrow 4,0 \times 10^{-8}$ & für & $\alpha_p$ [\si{Pa^{-1}}]
\end{tabular}
...
\end{equation}
%
wobei $T \ [\textrm{K}]$ die absolute Temperatur und $\rho_0 \ [\textrm{kg/m}^3]$ die Dichte ist.
