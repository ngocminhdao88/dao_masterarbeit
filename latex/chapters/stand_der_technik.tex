...
Das Öl, das starke Veränderung der Viskosität ist, wird mit \num{0} oder \si{LVI} (low viscosity index) indiziert.
Das andere Öl wird mit \num{100} oder \si{HVI} (high viscosity index) gekennzeichnet.
Aus dem Vergleich der kinematischen Viskosität eines zu beschreibenden Öls mit diesen beiden Referenzölen bei \SI{100}{\degree}  ergibt sich dessen Viskositätsindex, Formel \ref{eq:viskositaetsindex}.
% ----------------------------------------
% Eq: Viskositätsindex
% ----------------------------------------
\begin{equation}
...
\begin{tabular}{lll}
    \SI{0,001}{\pascal.\second} $\rightarrow$ \SI{0,1}{\pascal.\second} & für & $\eta_0$ \\
    \SI{0}{\per\pascal} $\rightarrow$ \SI{4.0e-8}{\per\pascal}          & für & $\alpha_p$
\end{tabular}
...
\end{equation}
%
wobei $c$ ein Ölkonstante ist (zB: SAE30, $c = $ \num{0,33}).
Der Brechungsindex für meist Mineralöle bei normalen Luftdruck ist c.a \num{1.51}.
