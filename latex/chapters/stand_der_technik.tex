...
\begin{align}
    ...
    H_0 &= \cfrac{2,69 G^{0,49} U_0^{0,68}}{W_0^{0,067}} (1 - 0,61 e^{-0,73 \chi}) \\
    %
    \text{mit} \quad
...
Die Einflüsse von Faktoren auf die Schmierfilmdicke der elastohydrodynamischen Schmierung werden in die Tabelle \ref{tab:faktor_einfluss_schmierfilmdicke} zusammengefasst.
% ----------------------------------------
