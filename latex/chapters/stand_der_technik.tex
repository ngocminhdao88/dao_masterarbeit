...
Im Si-Einheitensystem hat die dynamische Viskosität als Einheit \si{N.s/m^2} oder \si{\pascal.\s} und die kinematische Viskosität als Einheit \si{m^2/s}.
Ein Stoff hat die Viskosität \SI{1}{N.s/m^2}, wenn er in zwischen zwei Platten, die Größe von \SI{1}{m^2} und einen Abstand von \SI{1}{m} haben, befindet und man braucht \SI{1}{N}, um die zwei Platten gegeneinander mit einer Geschwindigkeit von \SI{1}{m/s} zu verschieben.
...
\end{equation}
%
wobei $\eta_{s}$ die Viskosität des Schmierstoffes bei der Temperatur $\phi_{s}$ ist, $\eta$ ist die Viskosität des Schmierstoffes bei der Temperatur $\phi$, $\Delta{\phi}$ ist die Temperaturdifferenz ($\eta = \eta_{s} + \Delta{\phi}$) und $\beta$ ist die thermoviskose Konstante.\improvement{check the formel}
% ----------------------------------------
...
Eine genauere Gleichung wurde von z.B Roelands\cite{roelands} vorgeschlagen
% ----------------------------------------
...
Der Druck-Viskositätskoeffizient $\alpha_p$ ist nicht eine Konstante, sondern eine Funktion der Temperatur.
...
Er beschreibt das Verhältnis von der Reibungskraft $F_R$ und der Normalkraft $F_N$
% ----------------------------------------
% Eq: Reibung
% ----------------------------------------
\begin{equation}
