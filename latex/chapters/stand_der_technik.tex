...
\improvement[inline]{Bilde zu jedem Reibungszustand}
% ----------------------------------------
% Subsec: Festkörperreibung
% ----------------------------------------
\subsection*{Festkörperreibung}
\label{sub:festkoerperreibung}
...
% Subsec: Grenzreibung
% ----------------------------------------
\subsection*{Grenzreibung}
\label{sub:grenzreibung}
...
% Subsec: Mischreibung
% ----------------------------------------
\subsection*{Mischreibung}
\label{sub:mischreibung}
...
% ----------------------------------------
% Subsec: Flüssigkeitsreibung
% ----------------------------------------
\subsection*{Flüssigkeitsreibung}
\label{sub:fluessigkeitsreibung}
...
\improvement[inline]{Tabelle der Kontaktformen}

% ----------------------------------------
% Subsec: Stribeck-Kurve
% ----------------------------------------
...
Nach den experimentellen Ergebnissen von Kyoe\improvement{Quelle} kann die Formel \ref{eq:mininmale_schmierfilmdicke_downson_hamrock} und \ref{eq:zentrale_schmierfilmdicke_downson_hamrock} im Bereich $0,117 < \chi < 3,7$ verwendet werden.
