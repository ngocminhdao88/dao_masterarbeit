...
Die Messmethode von \textit{Dwyer-Joyce} war in der Lage, Filme im Bereich von 50 bis 500 $nm$ zu messen.
...
\textit{Jones et al.} beschrieb in seiner Arbeit \cite{jones_2001} die Kalibrierung einer Technik, die auf Basis der Laserinduzierten Fluoreszenz zur quantitativen Messungen von industriellen Beschichtungen mit einer Dicke von 10-20 $nm$ ermöglicht.
...
Mit einem optischen Profilometer mittels Lasertriangulation wurden die Filmdicken von 220-450 $nm$ ermittelt.
...
\begin{figure}[htb]
    ...
    \caption{Schematische Aufbau der Kalibrierung mit Profilometer \cite{jones_2001}}
